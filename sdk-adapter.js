fetch('./config.json')
    ...
    .then(() => {
        ...
        if (window.AppConfig?.showAdOnStart){
            WelwiseGames.init()
                .then(sdk => {
